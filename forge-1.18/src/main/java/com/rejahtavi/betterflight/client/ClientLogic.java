...
public class ClientLogic {
    ...
    public static void init() {
        ClientLogic.takeOffKey = new KeyMapping(BetterFlight.MODID + ".keys.takeoff", KeyConflictContext.IN_GAME,
                KeyModifier.NONE, InputConstants.Type.KEYSYM.getOrCreate(GLFW.GLFW_KEY_SPACE), BetterFlight.MODID);
        ClientRegistry.registerKeyBinding(ClientLogic.takeOffKey);

        ClientLogic.flapKey = new KeyMapping(BetterFlight.MODID + ".keys.flap", KeyConflictContext.IN_GAME,
                KeyModifier.NONE, InputConstants.Type.KEYSYM.getOrCreate(GLFW.GLFW_KEY_SPACE), BetterFlight.MODID);
        ClientRegistry.registerKeyBinding(ClientLogic.flapKey);

        ClientLogic.flareKey = new KeyMapping(BetterFlight.MODID + ".keys.flare", KeyConflictContext.IN_GAME,
                KeyModifier.NONE, InputConstants.Type.KEYSYM.getOrCreate(GLFW.GLFW_KEY_X), BetterFlight.MODID);
        ClientRegistry.registerKeyBinding(ClientLogic.flareKey);

        ClientLogic.widgetPosKey = new KeyMapping(BetterFlight.MODID + ".keys.widget", KeyConflictContext.IN_GAME,
                KeyModifier.NONE, InputConstants.Type.KEYSYM.getOrCreate(GLFW.GLFW_KEY_F10), BetterFlight.MODID);
